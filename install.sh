...
if ! command -v nrich &> /dev/null; then
  ...
  case "$ARCH" in
    amd64)  NRICH_URL="https://gitlab.com/api/v4/projects/33695681/packages/generic/nrich/latest/nrich_latest_x86_64.deb" ;;
    arm64)  NRICH_URL="https://gitlab.com/api/v4/projects/33695681/packages/generic/nrich/latest/nrich_latest_aarch64.deb" ;;
    *)
